...
@app.route('/google')
def g():
    return jsonify(busqueda_iniciar('zapatos'))
...
def prueba():
    ...
    return jsonify(iniciar(p1,p2,p3,p4))
...
def getProduct(id,fecha,ciudad,entidad_especialidad):
    return jsonify(iniciar(id,fecha,ciudad,entidad_especialidad))
